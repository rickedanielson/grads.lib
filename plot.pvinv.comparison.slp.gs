...
*
*     grads -blc "plot.pvinv.comparison.slp 767605.totl.res.nc 767605.totl.nc"
*
...
"run gui_date"
date = result
"draw string 4.25 0.4 "date" SLP Differences ("conin.0" hPa)"
"set strsiz 0.1 0.1"
"draw string 4.25 0.1 "infila" - "infilb
"run gui_print plot.pvinv.comp.slp."infila"."infilb
"quit"
