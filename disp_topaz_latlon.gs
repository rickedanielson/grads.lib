* This script plots lat and lon labels for
* a SAR acquistion that isn't aligned along
...
"d latitude"                                             ;* labels for this plot
...
"set y "latmin
"define tmplats=latitude"
"define tmplons=longitude"
"set gxout value"
"set x "lonmin
"d tmplats"
...
say   "'draw line "xpos" "yb" "xpos+shift" "yb-delta"'"
...
say   "'draw string "xpos" "yb-2*delta" "tmplab"'"
    endif
    a = a + dela
  endwhile
endif
...
say   "'draw line "xpos" "yt" "xpos-shift" "yt+delta"'"
      if (lonlab.a > 180) ; lonlab.a = lonlab.a - 360 ; endif
      if (lonlab.a < 0) ; tmplab = -lonlab.a"W" ; endif ; if (lonlab.a = -180) ; tmplab = -lonlab.a ; endif
      if (lonlab.a > 0) ; tmplab =  lonlab.a"E" ; endif ; if (lonlab.a =  180) ; tmplab =  lonlab.a ; endif
      if (lonlab.a = 0) ; tmplab =  lonlab.a    ; endif
       "draw string "xpos" "yt+2*delta" "tmplab
say   "'draw string "xpos" "yt+2*delta" "tmplab"'"
    endif
    a = a + dela
  endwhile
endif
...
say   "'draw line "xl" "ypos" "xl-delta" "ypos-shift"'"
...
say   "'draw string "xl-1.25*delta" "ypos-shift" "tmplab"'"
    endif
    a = a + dela
  endwhile
endif
...
say   "'draw line "xr" "ypos" "xr+delta" "ypos+shift"'"
      if (latlab.a > 0) ; tmplab =  latlab.a"N" ; endif
      if (latlab.a < 0) ; tmplab = -latlab.a"S" ; endif
      if (latlab.a = 0) ; tmplab =  latlab.a    ; endif
       "draw string "xr+1.25*delta" "ypos+shift" "tmplab
say   "'draw string "xr+1.25*delta" "ypos+shift" "tmplab"'"
    endif
    a = a + dela
  endwhile
endif
