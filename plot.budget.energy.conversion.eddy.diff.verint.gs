...
*
*     grads -bpc "plot.budget.energy.conversion.eddy.diff.verint 111111"
*
...
budget = "budget.energy.conversion.eddy.diff"
...
while (a < 4)
  ...
  while (b <= timb)
    ...
    "run disp_shaded_stat "var.a"stat"
