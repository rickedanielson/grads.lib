...
*     d_uv.gs is a GrADS script to display wind barbs. This script dynamically
*     sets the skip parameter based on the plot dimensions. Doesn't do a great job
*     on polar stereographic plots.
