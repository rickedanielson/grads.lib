...
*     page.gs is an easy way plot multiple graphs. For example, "run page left"
*     will set vpage to the left side of the page. There are many options. 
*     pagetrans.gs is very similar to page.gs. The only difference is that the
*     margins are set for viewgraphs. 
