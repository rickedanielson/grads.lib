...
*     map.gs is a script to change the type of map. The script is easy to use,
*     just type "run map" and answer the prompt. Once you figured out the various
*     maps, you can save time by typing "run map [map type]". Updated (5-28-97). 
