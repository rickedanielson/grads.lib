...
var = "(stab(lev=850)+stab(lev=700)+stab(lev=600))/3"
scale = "e7"
var.1.1 = "(stab(lev=850)+stab(lev=700)+stab(lev=600))/3*1"scale
var.2.1 = "(stab.2(lev=850)+stab.2(lev=700)+stab.2(lev=600))/3*1"scale
var.2.2 = "stabstat.2(lev=700)"
var.3.1 = "(stab.3(lev=850)+stab.3(lev=700)+stab.3(lev=600))/3*1"scale
conin.1 = 3
conin.2 = 1
conin.3 = 3
cenval.1 = 12
...
while (a < 5)
  ...
  "set cthick 4"
  "set clab off"
  "run disp_shaded_nozero "var.1.1" "conin.1" "cenval.1
  "set clab on"
  "run disp_unshaded_nozero "var.1.1" "3*conin.1" "cenval.1
  ...
  "set cthick 4"
  "set clab off"
  "run disp_shaded_nozero "var.3.1" "conin.3" "cenval.3
  "set clab on"
  "run disp_unshaded_nozero "var.3.1" "3*conin.3" "cenval.3
...
"draw string 4.25 10.7 850-700-hPa Static Stability ("conin.1""scale" m2/s2/Pa2) and Diff ("conin.2""scale" m2/s2/Pa2)"
"run gui_print plot.twin.evol.stab"
"quit"
