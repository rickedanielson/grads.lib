...
"set strsiz 0.2 0.2"
#"set string 1 l"
"draw string 5.5 8.3 `3r`0`barea-weighted`n = "rhow
#"draw string 8.0 8.0 `3r`0`bunweighted`n = "rhou

"set string 1 c 1 90"
"draw string 0.5 4.3 "argb
"set string 1 c 1 0"
"draw string 5.5 0.7 "arga

"set string 1 l"
"set strsiz 0.15 0.15"
"draw string 0.4 8.3 "numdef" def boxes"
"draw string 0.4 8.0 "nundef" undef boxes"

"draw string 8.2 8.3 lat = ["latminv","latmaxv"]"
"draw string 8.2 8.0 lon = ["lonminv","lonmaxv"]"
