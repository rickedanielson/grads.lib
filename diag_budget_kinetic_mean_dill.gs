...
#"d uwnd-uwnd.2(t=1);vwnd-vwnd.2(t=1)"                       ;# perturbation wind vector
#"d dilx;dily"                                               ;# dilitation vector
#"d 180 / 3.141592 * 0.5 * atan2(deformy,deformx)"           ;# angle of dilitation axis
#"d deformx / cos(atan2(deformy,deformx))"                   ;# total deformation
#"d vint(sfcpres/100,reynolds,100)"                          ;# Reynolds' stress approx
...
defa = "deformx = cdiff(uwnd.2(t=1),x) / delx - cdiff(vwnd.2(t=1),y) / dely - vwnd.2(t=1) * tan(lat*D2R) / EARTH"
  say  "  "defa ; say ""
  "define "defa

defa = "deformy = cdiff(vwnd.2(t=1),x) / delx + cdiff(uwnd.2(t=1),y) / dely + uwnd.2(t=1) * tan(lat*D2R) / EARTH"
  say  "  "defa ; say ""
  "define "defa

defa = "ex = 0.5 * (pow(vwnd-vwnd.2(t=1),2) - pow(uwnd-uwnd.2(t=1),2))"
  say  "  "defa ; say ""
  "define "defa

defa = "ey = -(uwnd-uwnd.2(t=1)) * (vwnd-vwnd.2(t=1))"
  say  "  "defa ; say ""
  "define "defa

defa = "reynolds = ex * deformx + ey * deformy"
  say  "  "defa ; say ""
  "define "defa

defa = "dilx = deformx / cos(atan2(deformy,deformx)) * cos(0.5*atan2(deformy,deformx))"
  say  "  "defa ; say ""
  "define "defa

defa = "dily = deformx / cos(atan2(deformy,deformx)) * sin(0.5*atan2(deformy,deformx))"
  say  "  "defa ; say ""
  "define "defa
