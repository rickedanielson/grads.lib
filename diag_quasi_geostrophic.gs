...
defa = "qvecu = -(cdiff(-GRAV / coriol * cdiff(hgt,y) / dely,x) / delx * cdiff(air * pow(1000/lev,287.0/1004.0),x) / delx +"
defb =           "cdiff( GRAV / coriol * cdiff(hgt,x) / delx,x) / delx * cdiff(air * pow(1000/lev,287.0/1004.0),y) / dely)"
  say  "  "defa" "defb ; say ""
  "define "defa" "defb

defa = "qvecv = -(cdiff(-GRAV / coriol * cdiff(hgt,y) / dely,y) / dely * cdiff(air * pow(1000/lev,287.0/1004.0),x) / delx +"
defb =           "cdiff( GRAV / coriol * cdiff(hgt,x) / delx,y) / dely * cdiff(air * pow(1000/lev,287.0/1004.0),y) / dely)"
  say  "  "defa" "defb ; say ""
  "define "defa" "defb

defa = "qvecon = -2.0 * (287.0 / lev/100.0) * pow(lev/1000,287.0/1004.0) *"
defb =          "hdivg(-(cdiff(-GRAV / coriol * cdiff(hgt,y) / dely,x) / delx * cdiff(air * pow(1000/lev,287.0/1004.0),x) / delx +"
defc =                  "cdiff( GRAV / coriol * cdiff(hgt,x) / delx,x) / delx * cdiff(air * pow(1000/lev,287.0/1004.0),y) / dely),"
defd =                "-(cdiff(-GRAV / coriol * cdiff(hgt,y) / dely,y) / dely * cdiff(air * pow(1000/lev,287.0/1004.0),x) / delx +"
defe =                  "cdiff( GRAV / coriol * cdiff(hgt,x) / delx,y) / dely * cdiff(air * pow(1000/lev,287.0/1004.0),y) / dely))"
  say  "  "defa" "defb" "defc" "defd" "defe ; say ""
  "define "defa" "defb" "defc" "defd" "defe
