...
*        grads -bpc "plot.growth.rates.energy.eddy.conversion.comp 111111"
*
...
while (a < 4)
  ...
  while (b < 5)
    if (b = 4)                                                     ;# include other terms in residual
      var = "maskout("var.b""dom.a" + gvfc"dom.a",num"dom.a"-"cutoffnum")"
    else
...
"set string 1 c"
"draw string 4.25 10.8 Average Eddy Energy Conversion"
"draw string 4.25 0.32 Notes: residual term (cres) includes gvfc term and"
