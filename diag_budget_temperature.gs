...
vintpres = 100.0
say ""
say "calculating vertical averages in LOG P from sfc to "vintpres
say ""

defa = "airvint = vint(sfcpres/100,air/lev,"vintpres")/vint(sfcpres/100,(1.0-sfcpres+sfcpres)/lev,"vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "ttendvavg = vint(sfcpres/100,ttendmid/lev,"vintpres")/vint(sfcpres/100,(1.0-sfcpres+sfcpres)/lev,"vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "thfcvavg = vint(sfcpres/100,thfcmid/lev,"vintpres")/vint(sfcpres/100,(1.0-sfcpres+sfcpres)/lev,"vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "tvfcvavg = vint(sfcpres/100,tvfcmid/lev,"vintpres")/vint(sfcpres/100,(1.0-sfcpres+sfcpres)/lev,"vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "tadivavg = vint(sfcpres/100,tadimid/lev,"vintpres")/vint(sfcpres/100,(1.0-sfcpres+sfcpres)/lev,"vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "tresvavg = vint(sfcpres/100,tresmid/lev,"vintpres")/vint(sfcpres/100,(1.0-sfcpres+sfcpres)/lev,"vintpres")"
  say  "  "defa ; say ""
  "define "defa
