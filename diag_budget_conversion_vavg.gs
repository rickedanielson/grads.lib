...
say ""
say "calculating PE-KE conversion terms, vertically"
...
defa = "ckgenmidvavg = vint(sfcpres / 100.0, ckgenmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "cghfcmidvavg = vint(sfcpres / 100.0, cghfcmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "cgvfcmidvavg = vint(sfcpres / 100.0, cgvfcmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "cbaromidvavg = vint(sfcpres / 100.0, cbaromid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "cresmidvavg = vint(sfcpres / 100.0, cresmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "cabremidvavg = vint(sfcpres / 100.0, cabremid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa
