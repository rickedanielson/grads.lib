...
*
*     grads -bpc "plot.basic.coupling.index.gb decjan 40 140"
*
...
"set string 1 c"
"draw string 4.25 0.55 850-hPa Coupling Index ("conin.2"`3.`0K) Anomaly ("conin.1"`3.`0K)"
"draw string 4.25 0.20 and t-Test Significance (shaded)"
"set strsiz 0.1 0.1"
"set string 1 l"
"draw string 6.0 10.8 "tag
"run disp_label_95_99 1 1 1.3 9.5 10"
"run gui_print plot."tag".basic.coupling.index"
"quit"
