...
*
*     grads -blc "plot.mm5.comparison.kediff"
*
* - RD November 2001.
...
while (a <= timb)
  ...
  "set line 2 1 15"
  "run gui_track_simple 6 manulat.6 manulon.6 6 "dotsize" "bigdot
  "set line 1 1 4"
  "set cthick 10"
  "set ccolor 1"
...
#  "draw string 10.5 8.2 Full Removal"
  ...
  if (a = tima)
    b = 10
    while (b < 12)
      say "printim kediff."b".gif gif x1200 y900"
          "printim kediff."b".gif gif x1200 y900"
      b = b + 1
    endwhile
  endif
  say "printim kediff."b".gif gif x1200 y900"
