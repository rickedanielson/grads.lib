...
*
*     grads -blc "plot.scat.wind.polr 2005D07-10_31545_01.00012.scat.txt.nhcjtwc"
*
* - RD April 2004.
...
left = 5                                                           ;* plotvar on lhs (1=oldv      2=newv      3=unco      4=frnk       5=hwnd      11=nnet)
                                                                   ;*                (6=oldv+sfmr 7=newv+sfmr 8=hwnd+sfmr 9=frnk+sfmr 10=hwnd+sfmr 12=nnet+sfmr)
...
*   if (a = 1) ; vpage.a.b = lef.a+dd" "rig.a-dd" "bot.b+dd" "top.b-dd ; endif
  b = b + 1 ; endwhile
a = a + 1 ; endwhile
...
"set dfile 4"
if (left = 1 | left =  6) ; plotvar = "qs_spd_orig.4*1.94384" ; endif
if (left = 2 | left =  7) ; plotvar = "qs_spd_ku2010.4*1.94384" ; endif
if (left = 3 | left =  8) ; plotvar = "qs_spduncorr_ku.4*1.94384" ; endif
if (left = 4 | left =  9) ; "quit" ; endif
if (left = 5 | left = 10) ; plotvar = "hwspd.4*1.94384" ; endif
if (left =11 | left = 12) ; plotvar = "annspd.4*1.94384" ; endif
if (left = 1 | left =  6) ; plotvar = "w0qs_spd_orig.4*1.94384" ; endif
if (left = 2 | left =  7) ; plotvar = "w0qs_spd_ku2010.4*1.94384" ; endif
if (left = 3 | left =  8) ; plotvar = "w0qs_spduncorr_.4*1.94384" ; endif
if (left = 4 | left =  9) ; "quit" ; endif
if (left = 5 | left = 10) ; plotvar = "w0hwspd.4*1.94384" ; endif
if (left =11 | left = 12) ; plotvar = "w0annspd.4*1.94384" ; endif
"set parea "vpage.1.1
"set lon 0 360"
"set y 1 12"
"set mproj nps"
...
if (left = 1 | left =  6) ; plotvas = "w1qs_spd_orig.4*1.94384" ; endif
if (left = 2 | left =  7) ; plotvas = "w1qs_spd_ku2010.4*1.94384" ; endif
if (left = 3 | left =  8) ; plotvas = "w1qs_spduncorr_.4*1.94384" ; endif
if (left = 4 | left =  9) ; "quit" ; endif
if (left = 5 | left = 10) ; plotvas = "w1hwspd.4*1.94384" ; endif
if (left =11 | left = 12) ; plotvas = "w1annspd.4*1.94384" ; endif
"set grads off" ; "set cint 2" ; "d "plotvas
*"run disp_scat_latlon_polr 0.08 1 1 1 1"
*"run gui_track_scat 3 blats.3 blons.3 1 0.02 0.0 3"
"q w2xy 0 90" ; rec = sublin(result,1) ; obsx = subwrd(rec,3) ; obsy = subwrd(rec,6)
...
if (left =11 | left = 12) ; plotvar = "annspd.2*1.94384" ; endif
"set parea "vpage.2.1
"set x "minbon" "maxbon
"set y "minbat" "maxbat
"set mproj off"
...
if (left = 2 | left =  7 | left = 3 | left =  8 | left =11 | left = 12)
...
*endif
if (left = 1 | left =  6) ; plotvas = "qs_spd_orig" ; endif
if (left = 2 | left =  7) ; plotvas = "qs_spd_ku2010" ; endif
if (left = 3 | left =  8) ; plotvas = "qs_spduncorr_ku" ; endif
if (left = 4 | left =  9) ; "quit" ; endif
if (left = 5 | left = 10) ; plotvas = "hwspd" ; endif
if (left =11 | left = 12) ; plotvas = "annspd" ; endif
"set cthick 10" ; "set ccolor 0" ; "set clevs 1.5" ; "d "plotvas ; "set cthick 3"
...
if (seebias = 0 | (sfok = 0 & drok = 0))
  ...
  if (left =11 | left = 12) ; "draw string "clr.1-0.5" "top.1+0.4" Neural Net" ; endif
  ...
  if (left =11 | left = 12) ; spd = math_format("%.0f",nnet_vmax) ; endif
...
if (left =  1) ; plotnam = "polr."stem".oldv" ; endif
if (left =  2) ; plotnam = "polr."stem".newv" ; endif
if (left =  3) ; plotnam = "polr."stem".unco" ; endif
if (left =  4) ; plotnam = "polr."stem".frnk" ; endif
if (left =  5) ; plotnam = "polr."stem".hwnd" ; endif
if (left =  6) ; plotnam = "polr."stem".oldv.sfmr" ; endif
if (left =  7) ; plotnam = "polr."stem".newv.sfmr" ; endif
if (left =  8) ; plotnam = "polr."stem".unco.sfmr" ; endif
if (left =  9) ; plotnam = "polr."stem".frnk.sfmr" ; endif
if (left = 10) ; plotnam = "polr."stem".hwnd.sfmr" ; endif
if (left = 11) ; plotnam = "polr."stem".nnet" ; endif
if (left = 12) ; plotnam = "polr."stem".nnet.sfmr" ; endif
