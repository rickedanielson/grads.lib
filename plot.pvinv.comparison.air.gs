...
*
*     grads -bpc "plot.pvinv.comparison.air 767605.totl.res.nc 767605.totl.nc"
*
...
while (a < 9)
  ...
  "set cthick 4"
  "d "var.0
  "draw title "lev.a"-hPa Temperature ("conin.1.a" K)"
  a = a + 1
endwhile
...
"run gui_date"
date = result
"draw string 4.25 0.4 "date" Temperature Differences ("conin.0" K)"
"set strsiz 0.1 0.1"
"draw string 4.25 0.1 "infila" - "infilb
"run gui_print plot.pvinv.comp.air."infila"."infilb
"quit"
