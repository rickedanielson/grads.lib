...
say ""
say "calculating eddy kinetic energy budget terms, vertically"
...
defa = "ekinemidvavg = vint(sfcpres / 100.0, ekinemid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "ektendmidvavg = vint(sfcpres / 100.0, ektendmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "ekhfcmidvavg = vint(sfcpres / 100.0, ekhfcmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "ekvfcmidvavg = vint(sfcpres / 100.0, ekvfcmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "ekreymidvavg = vint(sfcpres / 100.0, ekreymid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "ekresmidvavg = vint(sfcpres / 100.0, ekresmid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa

defa = "ekabremidvavg = vint(sfcpres / 100.0, ekabremid, "vintpres") / vint(sfcpres / 100.0, one, "vintpres")"
  say  "  "defa ; say ""
  "define "defa
