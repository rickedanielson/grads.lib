...
*
*     grads -blc "plot.globcurrent.components.brochure 2012092000"
*
* - RD October 2014.
...
"set rgb  45   0   0 200"
"set rgb  46   0  50 255"
"set rgb  47   0 150 255"
"set rgb  48   0 255 255"
"set rgb  49  50 255 255"
"set rgb  50 150 255 255"
...
label.1 = cen.1" "top.2-0.1" Geostrophic (ms`a-1`n)"
label.2 = cen.2" "top.2-0.1" Surface Ekman (ms`a-1`n)"
label.3 = cen.2" "top.1-0.1" Stokes (ms`a-1`n)"
label.4 = cen.1" "top.1-0.1" Tidal (ms`a-1`n)"
label.5 = cen.3" "top.2-0.1" 15-m Ekman (ms`a-1`n)"
label.6 = cen.3" "top.1-0.1" Sea Level Pressure (hPa)"
...
*   "set display black"
    ...
    if (a = 3 & b = 2)
      "set gxout contour"
      "set cint 4" ; "set ccols 0" ; "set cthick 6"
      ...
      "set cint 4" ; "set ccols 1" ; "set cthick 6"
