...
*
*     grads -blc "plot.globcurrent.drifter.norskhavet lofoten_basin.xyzzy 109 2010-01-01-12 ../norskhavet/norskhavet_20100101120000-GLOBCURRENT-L4-CUReul_15m-ALT_SUM-v01.0-fv01.0.nc    65.000    75.000   -10.000    20.000"
...
infile = "/home/ricani/work/workt/norskhavet.lofoten"
filestat = read(infile)
...
while (message = 0)
  ...
  tmpc = subwrd(line,1)
  tmpd = subwrd(line,2)
  "q w2xy "tmpa" "tmpb ; rec = sublin(result,1) ; obsxa = subwrd(rec,3) ; obsya = subwrd(rec,6)
  "q w2xy "tmpc" "tmpd ; rec = sublin(result,1) ; obsxb = subwrd(rec,3) ; obsyb = subwrd(rec,6)
  "set line  1 1 10" ; "draw line "obsxa" "obsya" "obsxb" "obsyb
  tmpa = tmpc ; tmpb = tmpd
  filestat = read(infile)
  message = sublin(filestat,1)
endwhile
filestat = close(infile)
...
* "set line 4 1 3"
* "set grads off"
  "run gui_track_simple_noline 2 simlat.2 simlon.2 -1 0.0 0.10 3 4 dist.2"
  "close 2"
  count = count + 1
  filestat = read(infilc)
  message = sublin(filestat,1)
...
say "gxprint plot.globcurrent.drift."infild".png png white x1100 y850"
    "gxprint plot.globcurrent.drift."infild".png png white x1100 y850"
"quit"
