...
*
*     grads -bpc "plot.twin.evol.meddvint midwinter    transitional  37 145"
*     grads -bpc "plot.twin.evol.meddvint dj30d        om30d         37 145"
*     grads -bpc "plot.twin.evol.meddvint gd2000.dj30d gd2000.om30d  37 145"
*     grads -bpc "plot.twin.evol.meddvint atlmid       atltra        42 -50"
*     grads -bpc "plot.twin.evol.meddvint dec          mar           37 145"
*
...
"draw string 4.25 10.2 Vertical Integral of Mean-Eddy APE Conversion ("conin.1" W/m2)"
"draw string 4.25 9.9      and Difference ("conin.2" W/m2)"
"set strsiz 0.1"
"draw string 6.75 10.6 ("stema" "stemb")"
"run gui_print plot.twin.evol.meddvint."stema"."stemb
"quit"
