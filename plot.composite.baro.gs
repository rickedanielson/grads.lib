...
"sdfopen /home/rdanielson/data/western.bombs/111111.nc"
"sdfopen /home/rdanielson/data/western.bombs/111111.budget.energy.conversion.eddy.nc"
"sdfopen /home/rdanielson/data/western.bombs/111111.track.nc"
...
while (b < 3)
  ...
  "set clab off"
  "set cthick 8"
  "run disp_shaded_nozero barovint.2 15"
  "set cthick 4"
  "set clab off"
  ...
  "set cthick 4"
  "set clab on"
  "run disp_unshaded_nozero barovint.2 30"
...
#  "draw recf -0.5 "yb-0.5" "xl-0.12" "yt+0.5
  ...
  "set string 1 c"
  "set strsiz 0.25"
  "draw string 4.3 4.4 "title.a.b" "date
  b = b + 1
endwhile
...
"close 2"
"close 1"
"sdfopen /home/rdanielson/data/eastern.bombs/ncep/111111.nc"
"sdfopen /home/rdanielson/data/eastern.bombs/ncep/111111.budget.energy.conversion.eddy.nc"
"sdfopen /home/rdanielson/data/eastern.bombs/ncep/111111.track.nc"
...
#  "draw recf -0.1 "yb-0.5" "xl-0.12" "yt+0.5
  ...
  b = b + 1
endwhile
"run gui_print plot.composite.baro"
"quit"
