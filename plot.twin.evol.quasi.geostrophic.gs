...
*
*     grads -bpc "plot.twin.evol.quasi.geostrophic midwinter    transitional  37 145"
*     grads -bpc "plot.twin.evol.quasi.geostrophic dj30d        om30d         37 145"
*     grads -bpc "plot.twin.evol.quasi.geostrophic gd2000.dj30d gd2000.om30d  37 145"
*     grads -bpc "plot.twin.evol.quasi.geostrophic atlmid       atltra        42 -50"
*     grads -bpc "plot.twin.evol.quasi.geostrophic dec          mar           37 145"
*
...
var.1 = "("parname"(lev=500)+"parname"(lev=400)+"parname"(lev=300))/3*1e18"
var.2 = "("parname".2(lev=500)+"parname".2(lev=400)+"parname".2(lev=300))/3*1e18"
var.3 = "("parname".3(lev=500)+"parname".3(lev=400)+"parname".3(lev=300))/3*1e18"
...
"draw string 4.25 10.2 500-300-hPa Q-Vector Convergence ("conin.1"e-18 /Pa/s3)"
"draw string 4.25 9.9      and Difference ("conin.2"e-18 /Pa/s3)"
"set strsiz 0.1"
"draw string 6.75 10.6 ("stema" "stemb")"
"run gui_print plot.twin.evol.qvecon."stema"."stemb
"quit"
