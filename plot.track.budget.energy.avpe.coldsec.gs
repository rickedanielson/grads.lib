...
*
*     grads -bpc "plot.track.budget.energy.avpe.coldsec"
*
* - RD April 2003.
...
trackname = "track.nc"
slpname   = "slp.nc"
vertname  = "track.forcing.energy.avpe.coldsec.nc"
...
title.5 =  "Amed ("conin.5" W/m2) Diff ("0.5*conin.5" W/m2) Profile (*1e3 m2/s3)"
...
#    "run disp_unshaded_nozero "sca.a"*"var.a" "6*conin.a
    ...
    trackpos = result
    "run disp_box 12.5 12.5 -2.5 -20 "trackpos" "trackpos
