...
defa = "eforma = (uwnd-uwnd.2(t=1)) * cdiff((air-air.2(t=1))*pow(1000/lev,287/1004),x) / delx +"
defb =          "(vwnd-vwnd.2(t=1)) * cdiff((air-air.2(t=1))*pow(1000/lev,287/1004),y) / dely +"
defc =          "(omega-omega.2(t=1)) * ((air(z-1)-air.2(t=1,z-1)) - (air(z+1)-air.2(t=1,z+1))) / (lev(z-1) - lev(z+1)) / 100.0"
