...
*
*     grads -bpc "plot.basic.shtfl.med.gb dj30d        om30d        45 150"
*     grads -bpc "plot.basic.shtfl.med.gb gd2000.dj30d gd2000.om30d 45 150"
*     grads -bpc "plot.basic.shtfl.med.gb atlmid       atltra       45 -52.5"
*
...
"set string 1 c"
"draw string 4.25 0.20 10d-30d Sensible Heat Flux ("conin.1" W/m2) Diff ("conin.2" W/m2)"
"set strsiz 0.1 0.1"
"set string 1 c"
...
"run gui_print plot.basic.shtfl.med."fila"."filb
"quit"
