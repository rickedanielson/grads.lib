...
*
*     grads -bpc "plot.budget.wave.activity.verint.indv.case 767605"
*
...
var.4 = "cresvint"
var.5 = "gvfcvint"
vecvar = "uwavevavg vwavevavg 1500"
...
title.0 = "Wave Activity ("conin.0" m/s) and Flux (m2/s2)"
...
#    "run gui_view_grid "dellat" "dellon" "budgetpos
    ...
    "set cthick 10"
    "set clab off"
    "run disp_masks_one mask.4 wavevavg 20.01"
    "set cthick 4"
