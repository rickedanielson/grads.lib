...
*
*     grads -bpc "plot.track.forcing.summary.energy.kinetic"
*
...
a = 1
while (a < 5)
  "sdfopen "file.a.1"-"file.a.2".track.forcing.energy.kinetic.nc"
  "sdfopen "file.a.1".track.forcing.energy.kinetic.nc"
  "sdfopen "file.a.2".track.forcing.energy.kinetic.nc"
  "set t "time
  "set lev "level
