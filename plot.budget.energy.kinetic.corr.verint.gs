...
*
*     grads -bpc "plot.budget.energy.kinetic.corr.verint 111111"
*
...
title.8 = "Corr Hor Flux Conv ("conin.8" W/m2)"
title.9 = "Corr Ver Flux Conv ("conin.9" W/m2)"
title.10 = "Non-Stationary Forcing ("conin.10" W/m2)"
...
while (a < 11)
  ...
  while (b <= timb)
    ...
    if (a = 0)
      ...
      if (c = 6)
        "run disp_vector ukinevint vkinevint 5e7"
      else
        "run disp_vector_nolab ukinevint vkinevint 5e7"
      endif
    else
