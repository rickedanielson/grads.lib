...
*
*     grads -bpc "plot.track.budget.energy.avpe"
*
* - RD April 2003.
...
trackname = "track.nc"
slpname   = "slp.nc"
vertname  = "track.forcing.energy.avpe.nc"
...
title.1 = "Eddy APE ("conin.1" MJ/m2) Difference ("0.5*conin.1" MJ/m2) Profile (*1e-2 m2/s2)"
title.2 = "Atend ("conin.2" W/m2) Diff ("0.5*conin.2" W/m2) Profile (*1e3 m2/s3)"
title.3 =  "Ahfc ("conin.3" W/m2) Diff ("0.5*conin.3" W/m2) Profile (*1e3 m2/s3)"
title.4 =  "Avfc ("conin.4" W/m2) Diff ("0.5*conin.4" W/m2) Profile (*1e3 m2/s3)"
title.5 =  "Mean to Eddy APE ("conin.5" W/m2) Difference ("0.5*conin.5" W/m2) Profile (10  m2/s3)"
title.6 =  "Aefo ("conin.6" W/m2) Diff ("0.5*conin.6" W/m2) Profile (*1e3 m2/s3)"
title.7 =  "Abro ("conin.7" W/m2) Diff ("0.5*conin.7" W/m2) Profile (*1e3 m2/s3)"
title.8 =  "Ares ("conin.8" W/m2) Diff ("0.5*conin.8" W/m2) Profile (*1e3 m2/s3)"
...
#    "set z "leva" "levb
  ...
  if (sta = 5)
    ...
    "draw string 7.30 10.8 -3"
  endif
  "run gui_print plot.track.budget.energy.avpe."var.a
  a = a + 1
endwhile
"quit"
