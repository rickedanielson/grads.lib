...
*
*     grads -bpc "plot.track.forcing.summary.energy.avpe.coldsec"
*
...
a = 1
while (a < 5)
  "sdfopen "file.a.1"-"file.a.2".track.forcing.energy.avpe.coldsec.nc"
  "sdfopen "file.a.1".track.forcing.energy.avpe.coldsec.nc"
  "sdfopen "file.a.2".track.forcing.energy.avpe.coldsec.nc"
  "set t "time
  "set lev "level
