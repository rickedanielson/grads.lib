...
*
*     grads -bpc "plot.pvinv.comparison.pv.same 767605.mean.output.potential.vorticity.mean.nc 767605.totl.potential.vorticity.mean.nc"
*
...
while (a < 9)
  ...
  "set cthick 4"
  "d "var.0
#  "run disp_unshaded_nozero "var.0" "conin.1.a
#  "run disp_unshaded_nozero "var.1" "conin.1.a
...
#"draw string 4.25 0.4 "date" QGPV inversion Final Pseudo PV"
"set strsiz 0.1 0.1"
