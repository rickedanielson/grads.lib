...
defa = "uheformo = uwnd * cdiff(uwnd,x) / delx + vwnd * cdiff(uwnd,y) / dely"
  say  "  "defa ; say ""
  "define "defa

defa = "vheformo = uwnd * cdiff(vwnd,x) / delx + vwnd * cdiff(vwnd,y) / dely"
  say  "  "defa ; say ""
  "define "defa

defa = "uveformo = (omega + omega(z-1)) / 2.0 * (uwnd(z-1) - uwnd) / (lev(z-1) - lev) / 100.0"
  say  "  "defa ; say ""
  "define "defa

defa = "vveformo = (omega + omega(z-1)) / 2.0 * (vwnd(z-1) - vwnd) / (lev(z-1) - lev) / 100.0"
  say  "  "defa ; say ""
  "define "defa
