...
*
*     grads -bpc "plot.budget.energy.kinetic.mean.horavg 111111"
*
...
title.7 = "h) Non-Stationary Forcing ("conin.7" m2/s3)"
...
while (a < 6)
  ...
  if (a = 0)
    "d "var.8"avg - "var.8"avg ; -"var.8"avg"
  endif
  "draw title "title.a
  a = a + 1
endwhile
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Mean Kinetic Energy Budget - Areal Averages"
...
title.7 = "g) Non-Stationary Forcing ("conin.7" /s)"
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Mean Kinetic Energy Budget - Areal Average Growth Rates"
"draw string 4.35 0.40 over a quasi-Lagrangian domain of ("2*dellat","2*dellon")`3.`0 in (lat,lon)"
"draw string 4.35 0.15 shifted by ("shiftlat","shiftlon")`3.`0 relative to ("tracklat","tracklon")"
