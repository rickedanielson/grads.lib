...
*
*     grads -bpc "plot.basic.potential.vorticity.gb compare_1986 45 -65"
*
...
budget = "basic.potential.vorticity"
...
"sdfopen "tag".potential.vorticity.nc"
"sdfopen "tag".nc"
...
title.0 = "2-PVU Tropopause Potential Temperature ("conin.0" K)"
...
#"set vpage off"
    ...
    "set clab off"
    "run disp_shaded_nozero "var.0" 10 320"
    "set clab off"
...
#b=b+1
  ...
  "set string 1 c"
  "draw string 4.25 0.15 "title.0
#"draw string 4.25 3.5 "title.0
  "set strsiz 0.1 0.1"
  "set string 1 l"
  "draw string 6.0 10.8 "tag
  "run gui_print plot."tag".basic.potential.vorticity"
  a = a + 1
endwhile
