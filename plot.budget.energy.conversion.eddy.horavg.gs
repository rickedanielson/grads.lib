...
*
*     grads -bpc "plot.budget.energy.conversion.eddy.horavg 333333"
*
* If no argument (tag) is specified, the data files are assumed to be
* open and the script will not automatically exit.  If the tag is 333333,
...
title.0 = "a) Eddy Kinetic Energy ("conin.0" m2/s2)"
title.1 = "b) Eddy Generation ("conin.1" m2/s3)"
title.2 = "c) Eddy Geopot Hor Flux Conv ("conin.2" m2/s3)"
title.3 = "d) Eddy PE Conversion ("conin.3" m2/s3)"
title.4 = "e) Residual ("conin.4" m2/s3)"
title.5 = "f) Eddy Geopot Vert Flux Conv ("conin.5" m2/s3)"
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Eddy Energy Conversion Budget - Areal Averages"
...
title.1 = "a) Eddy Generation ("conin.1" /s)"
title.2 = "b) Eddy Geopot Hor Flux Conv ("conin.2" /s)"
title.3 = "c) Eddy PE Conversion ("conin.3" /s)"
title.4 = "d) Residual ("conin.4" /s)"
title.5 = "e) Eddy Geopot Vert Flux Conv ("conin.5" /s)"
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Eddy Energy Conversion Budget - Areal Average Growth Rates"
"draw string 4.35 0.40 over a quasi-Lagrangian domain of ("2*dellat","2*dellon")`3.`0 in (lat,lon)"
"draw string 4.35 0.15 shifted by ("shiftlat","shiftlon")`3.`0 relative to ("tracklat","tracklon")"
