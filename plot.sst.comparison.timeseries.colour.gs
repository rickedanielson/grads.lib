...
*
*     grads -bpc "plot.sst.comparison.timeseries.colour dj30d        om30d        42 151"
*     grads -bpc "plot.sst.comparison.timeseries.colour gd2000.dj30d gd2000.om30d 42 151"
*     grads -bpc "plot.sst.comparison.timeseries.colour atlmid       atltra       42 -55"
*     grads -bpc "plot.sst.comparison.timeseries.colour dec          mar          42 151"
*     grads -bpc "plot.sst.comparison.timeseries.colour gyakum.mb1.update gyakum.sn1.update 42 151"
*
...
vpage.1.2 = "0.1  3.2  5.2  7.7"
vpage.2.2 = "2.7  5.8  5.2  7.7"
vpage.3.2 = "5.3  8.4  5.2  7.7"
if (fila != "atlmid")
  vpage.1.3 = "0.1  3.2  2.9  5.4"
  vpage.2.3 = "2.7  5.8  2.9  5.4"
  vpage.3.3 = "5.3  8.4  2.9  5.4"
else
  vpage.1.3 = "0.1  3.2  7.5 10.0"
  vpage.2.3 = "2.7  5.8  7.5 10.0"
  vpage.3.3 = "5.3  8.4  7.5 10.0"
endif
...
#"run gui_print plot.sst.timeseries."fila"."filb
