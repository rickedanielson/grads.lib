...
*
*     grads -bpc "plot.basic.slp.med.gb dj30d        om30d        45 150"
*     grads -bpc "plot.basic.slp.med.gb gd2000.dj30d gd2000.om30d 45 150"
*     grads -bpc "plot.basic.slp.med.gb atlmid       atltra       45 -52.5"
*
...
var.1.1 = "slpanom/100"
var.2.0 = "stat.2"
var.2.1 = "slpanom.2/100"
var.3.0 = "stat.3"
var.3.1 = "slpanom.3/100"
conin.1 = 1
conin.2 = 1
...
"set string 1 c"
"draw string 4.25 0.20 10d-30d SLP ("conin.1" hPa) Diff ("conin.2" hPa)"
"set strsiz 0.1 0.1"
"set string 1 c"
...
"run gui_print plot.basic.slp.med."fila"."filb
"quit"
