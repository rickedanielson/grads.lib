...
*
*     grads -bpc "plot.twin.evol.stability midwinter    transitional  37 145"
*     grads -bpc "plot.twin.evol.stability dj30d        om30d         37 145"
*     grads -bpc "plot.twin.evol.stability gd2000.dj30d gd2000.om30d  37 145"
*     grads -bpc "plot.twin.evol.stability atlmid       atltra        42 -50"
*     grads -bpc "plot.twin.evol.stability dec          mar           37 145"
*
...
var.1 = "("parname"(lev=850)+"parname"(lev=700)+"parname"(lev=600))/3*1e7"
var.2 = "("parname".2(lev=850)+"parname".2(lev=700)+"parname".2(lev=600))/3*1e7"
var.3 = "("parname".3(lev=850)+"parname".3(lev=700)+"parname".3(lev=600))/3*1e7"
...
"draw string 4.25 10.2 850-600-hPa Static Stability ("conin.1"e-7 m2/s2/Pa2)"
"draw string 4.25 9.9      and Difference ("conin.2"e-7 m2/s2/Pa2)"
"set strsiz 0.1"
"draw string 6.75 10.6 ("stema" "stemb")"
"run gui_print plot.twin.evol.stab."stema"."stemb
"quit"
