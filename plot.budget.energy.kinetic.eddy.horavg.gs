...
*
*     grads -bpc "plot.budget.energy.kinetic.eddy.horavg 333333"
*
...
title.8 = "i) Non-Stationary Forcing ("conin.8" m2/s3)"
...
while (a < 6)
  ...
  if (a = 0)
    "d "var.9"avg - "var.9"avg ; -"var.9"avg"
  endif
  "draw title "title.a
  a = a + 1
endwhile
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Eddy Kinetic Energy Budget - Areal Averages"
...
title.8 = "h) Non-Stationary Forcing ("conin.8" /s)"
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Eddy Kinetic Energy Budget - Areal Average Growth Rates"
"draw string 4.35 0.40 over a quasi-Lagrangian domain of ("2*dellat","2*dellon")`3.`0 in (lat,lon)"
"draw string 4.35 0.15 shifted by ("shiftlat","shiftlon")`3.`0 relative to ("tracklat","tracklon")"
