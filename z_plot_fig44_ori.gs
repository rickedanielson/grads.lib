...
*
*     grads -bpc "z_plot_fig44_ori all.col.var.nc"
*     grads -bpc "z_plot_fig44_ori all.col.var.pert.nc"
*
* - RD April 2004.
...
label.3 = "2.75 3.5  U and V Wind (ms`a-1`n)"
label.4 = "6.55 10.4 Wind Direction (deg)"
label.5 = "6.55 6.9  V-Wind (ms`a-1`n)"
label.6 = "6.55 3.5  Radar Cross Section (dB)"
...
while (a < 2)
  ...
  while (b < 4)
    ...
    var.5 = var"vwnd"end
    var.6 = var"sigo"end
    par.1 = "pow(pow("var"wspd"end",2),0.5)"
    par.2 = "pow(pow("var"uwnd"end",2),0.5)"
    par.3 = "pow(pow("var"wind"end",2),0.5)"
    par.4 = "pow(pow("var"wdir"end",2),0.5)"
    par.5 = "pow(pow("var"vwnd"end",2),0.5)"
    par.6 = "pow(pow("var"sigo"end",2),0.5)"
    ref.1 = "gowspd"end
    ref.2 = "gouwnd"end
    ref.3 = "gowind"end
    ref.4 = "gowdir"end
    ...
    while (c < 7)
      ...
      "set gxout stat" ; "d "ref.c ; line = sublin(result,8) ; masklev = subwrd(line,4)
                         "d "par.c ; line = sublin(result,8) ; minlev  = subwrd(line,4) + tiny
      "set gxout grfill"
      "set gridln off"
      "set lat -1.5 5.5"
      "set lon -1.5 4.5"
...
#      "set clip 0 8.5 0 11"
      ...
      "set grads off" ; "d "par.c
#      "set datawarn off"
#      "set grads off" ; "d const(maskout(1,"minlev"-"par.c"),0,-u)"
#      "set gxout shaded"
      "set gxout contour"
      "set cthick 10"
      "set clab off"
      "set clevs 0.5"
      "set grads off" ; "d const(maskout(1,"masklev"-"par.c"),0,-u)"
      "set ccolor 4"
      "set cstyle 5"
      "set clevs 0.65"
      "set grads off" ; "d const(maskout(1,"minlev"-"par.c"),0,-u)"
...
#   "draw string 0.15  5.45 SAR Error Model - Fractional Magnitude (%)"
    "draw string 4.65 10.80 "title" (derr = "leval")"
    "draw string 4.65  0.06 SAR Error Length Scale (km)"
