...
* get the date and modify the track position
    ...
    while (inloop <= last)
      ...
      "run gui_date"
      date = result
      say "!/home/rdanielson/bin/nc.modify.fval.weasd "file" weasd "date" "lat" "lon
      say "!/home/rdanielson/bin/nc.modify.fval.weasd "file" weasd "date" "94-y" "x-1
          "!/home/rdanielson/bin/nc.modify.fval.weasd "file" weasd "date" "94-y" "x-1
      inloop = inloop + 1
    endwhile
  endif
