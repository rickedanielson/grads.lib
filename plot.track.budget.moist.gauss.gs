...
*
*     grads -bpc "plot.track.budget.moist.gauss"
*
* - RD April 2003.
...
title.1 = "Prate ("conin.1" mm/day) and Diff ("0.5*conin.1" mm/day)"
title.2 = "Lhtfl ("conin.2" mm/day) and Diff ("0.5*conin.2" mm/day)"

vertvar.1  = "varm"
vertvar.2  = "varn"

vertsca.1  = 1e3*24*3600
