...
*
*     grads -bpc "plot.track.forcing.summary.energy.total"
*
...
a = 1
while (a < 5)
  "sdfopen "file.a.1"-"file.a.2".track.forcing.energy.total.nc"
  "sdfopen "file.a.1".track.forcing.energy.total.nc"
  "sdfopen "file.a.2".track.forcing.energy.total.nc"
  "set t "time
  "set lev "level
