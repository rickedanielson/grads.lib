...
defa = "sdp = PS * pow(cos(lat*D2R),3.0) * sin((2*lon+SHIFT)*D2R)"
  say  "  "defa ; say ""
  "define "defa

defa = "sdu = CS * (1+1.5*pow(sin(lat*D2R),2.0)) * sin((2*lon+SHIFT+180)*D2R)"
  say  "  "defa ; say ""
  "define "defa

defa = "sdv = -2.5 * CS * sin(lat*D2R) * sin((2*lon+SHIFT+90)*D2R)"
  say  "  "defa ; say ""
  "define "defa
