...
title.0 = "500-hPa Omega ("conin.0" Pa/s)"
title.1 = "Sea Level Pressure ("conin.1" hPa)"
...
while (a < 2)
  ...
  while (b <= timb)
    ...
    if (a = 0)
      "run disp_shaded_nozero "var.a"(lev=500) "conin.a" "cenval.a
    else
