...
say ""
say "calculating integral terms, pointwise"
say ""
...
#defa = "ucal = -cdiff(strm,y) / dely + cdiff(velp,x) / delx"
#defa = "ucal = cdiff(velp,x) / delx"
defa = "ucal = -cdiff(strm,y) / dely"
  say  "  "defa ; say ""
  "define "defa

#defa = "vcal = cdiff(strm,x) / delx + cdiff(velp,y) / dely"
#defa = "vcal = cdiff(velp,y) / dely"
defa = "vcal = cdiff(strm,x) / delx"
  say  "  "defa ; say ""
  "define "defa

defa = "vortcal = hcurl(uwnd,vwnd)"
  say  "  "defa ; say ""
  "define "defa

defa = "divcal = hdivg(uwnd,vwnd)"
  say  "  "defa ; say ""
  "define "defa
