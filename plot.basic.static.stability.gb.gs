...
#var.2 = "(stab(lev=850)+stab(lev=700)+stab(lev=600))/3"
var.2 = "stab(lev="level")"
...
#  "run disp_stat_95_99 "var.0
  "run disp_shaded_nozero "var.2" "conin.2" "cenval.2
  "set clab on"
  "run disp_unshaded_nozero "var.2" "conin.2*2" "cenval.2
  "set clab off"
  "set cthick 8"
...
"set string 1 c"
"draw string 4.25 0.55 600-hPa to 850-hPa Averaged Static Stability ("conin.2" m4s2/kg2)"
