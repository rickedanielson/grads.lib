...
*
*     grads -bpc "plot.budget.energy.kinetic.totl.horavg 111111"
*
...
title.2 = "d) Q-L Hor Flux Conv ("conin.2" m2/s3)"
title.3 = "e) Generation ("conin.3" m2/s3)"
title.4 = "c) Residual ("conin.4" m2/s3)"
...
while (a < 6)
  ...
  if (a = 0)
    "d "var.6"avg - "var.6"avg ; -"var.6"avg"
  endif
  "draw title "title.a
  a = a + 1
endwhile
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Kinetic Energy Budget - Areal Averages"
...
"set vpage off"
"set string 1 c"
"draw string 4.35 0.65 Kinetic Energy Budget - Areal Average Growth Rates"
"draw string 4.35 0.40 over a quasi-Lagrangian domain of ("2*dellat","2*dellon")`3.`0 in (lat,lon)"
"draw string 4.35 0.15 shifted by ("shiftlat","shiftlon")`3.`0 relative to ("tracklat","tracklon")"
